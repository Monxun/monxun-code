...
ALLOWED_HOSTS = ['www.monxuncode.com', 'localhost', '127.0.0.1']
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # DIR GETS CREATED UPON RUNNING COMMAND collectstaticfiles OR WHATEVER
